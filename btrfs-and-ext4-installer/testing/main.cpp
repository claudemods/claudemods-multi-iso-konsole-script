...
void install_grub_ext4(const string& drive) {
    ...
    execute_command("cd /mnt && curl -LO https://github.com/claudemods/ApexCKGE/releases/download/CKGE-V1.04.3-base/apexfullhome.squashfs ");
    execute_command("unsquashfs -d -f apexfullhome.squashfs /mnt/home ");
    ...
    execute_command("cp /opt/sudoers /etc ");
