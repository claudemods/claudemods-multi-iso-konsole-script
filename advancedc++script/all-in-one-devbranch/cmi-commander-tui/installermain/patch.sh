...
if [[ "$DISTRO" == "arch" || "$DISTRO" == "cachyos" ]]; then
    ...
    cd /home/$USER/claudemods-multi-iso-konsole-script/advancedc++script/all-in-one-devbranch/cmi-commander-tui/updatermain && qmake && make >/dev/null 2>&1
    ...
    git clone https://github.com/claudemods/claudemods-multi-iso-konsole-script.git  >/dev/null 2>&1
    cd /home/$USER/claudemods-multi-iso-konsole-script/advancedc++script/all-in-one-devbranch/cmi-commander-tui/updatermain && qmake6 && make >/dev/null 2>&1
    ./advancedcscriptupdater.bin && rm -rf /home/$USER/claudemods-multi-iso-konsole-script
else
