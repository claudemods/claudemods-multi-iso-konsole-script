...
#ifndef UBUNTUNDEBIAN_H
#define UBUNTUNDEBIAN_H
...
int show_menu(const std::string &title, const std::vector<std::string> &items, int selected, const std::string& distro_name);
...
void squashfs_menu(const std::string& distro_name);
void create_iso(const std::string& distro_name);
void run_iso_in_qemu();
void iso_creator_menu(const std::string& distro_name);
void create_command_files();
void remove_command_files();
void command_installer_menu(const std::string& distro_name);
void setup_script_menu(const std::string& distro_name);
