#ifndef DEBIANISOCREATOR_H
#define DEBIANISOCREATOR_H
...
void print_banner() {
    ...
    "░╚════╝░╚══════╝╚═╝░░░░░░╚═════╝░╚═════╝░╚══════╝╚═╝░░░░░╚═╝░╚════╝░╚═════╝░╚═════╝░\n";
        std::cout << RESET;
        std::cout << RED << "Claudemods Debian ISO Creator Advanced C++ Script v1.01 21-06-2025" << RESET << std::endl;
...
void create_iso() {
    ...
    std::string build_image_dir = std::string(application_dir_path) + "/build-image-debian";
