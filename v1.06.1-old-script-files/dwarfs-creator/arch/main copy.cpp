...
int main() {
    try {
        ...
        std::cout << "Select a compression level:" << std::endl;
        std::cout << "1. Level 4" << std::endl;
        std::cout << "2. Level 5" << std::endl;
        std::cout << "3. Level 6" << std::endl;
        std::cout << "4. Level 7" << std::endl;
        std::cout << "5. Level 8" << std::endl;
        std::cout << "6. Level 9" << std::endl;
