...
sudo mkfs.btrfs -L "$BTRFS_LABEL" --compress="$COMPRESSION_TYPE" -f "$IMAGE_NAME"

# ===== Mount and Copy Files =====
echo "[3/5] Copying files with rsync (this may take a while)..."
...
# ===== Force Recompression =====
echo "[4/5] Optimizing compression..."
